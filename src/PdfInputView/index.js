...
function PdfInputView() {
    ...
    async function renderPage() {
        ...
        for (let i = 1; i <= pdf.numPages; i++) {
            ...
            console.log("page lenght", pdf.numPages, render_context);
            ...
            <div id="pdf-main-container">
                ...
                <div id="pdf-contents">
                    ...
                    <div id="image-convas-row">
                        {/* <div className="canvas-container" style={styles.wrapper} >
